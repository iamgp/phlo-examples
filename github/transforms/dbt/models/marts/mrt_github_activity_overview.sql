-- mrt_github_activity_overview.sql - GitHub activity overview mart for BI dashboards
...
Target: Iceberg marts schema, then published to PostgreSQL
...
base_metrics as (
    ...
    where
        activity_date >= date_params.anchor_date - interval '90' day
        and activity_date <= date_params.anchor_date
